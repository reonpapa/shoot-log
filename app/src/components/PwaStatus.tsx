...
export function PwaStatus() {
  ...
  if (!installPrompt && !notice && isOnline) return null;
  ...
  return <aside className="pwa-status" aria-live="polite">
    ...
    {isOnline && notice !== "update" && installPrompt && <button className="pwa-status__primary" onClick={() => void install()}>この端末にインストール</button>}
