...
function App() {
  ...
  useEffect(() => {
    ...
    let active = true;
    const usageKey = "shoot-log-usage-recorded-2.25.2";
  ...
  return <main className="app-shell">
    ...
    <header className="app-header"><div><p className="eyebrow">CLAY SHOOTING ANALYSIS</p><h1><img aria-hidden="true" alt="" src={`${import.meta.env.BASE_URL}favicon.svg`} />Shoot Log</h1></div><p className="version">Version 2.25.2</p></header>
    <PwaStatus />
