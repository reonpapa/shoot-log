...
type Screen = "list" | "form" | "round" | "analysis" | "edit-session" | "master" | "data" | "account" | "privacy" | "terms" | "ammunition" | "permit";
const MAX_ROUNDS = 4;
...
function App() {
  ...
  const publicScreen = screen === "privacy" || screen === "terms";
  ...
  return <main className="app-shell">
    <header className="app-header"><div><p className="eyebrow">CLAY SHOOTING ANALYSIS</p><h1>Shoot Log</h1></div><p className="version">Version 2.5.0</p></header>
    <PwaStatus />
